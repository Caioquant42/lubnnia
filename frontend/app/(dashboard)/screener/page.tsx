...
import { ArrowRight, ScanSearch, ActivitySquare, Aperture, BarChart } from "lucide-react";
  ...
  const screenerTools = [
    {
      ...
      description: "Identifique ativos sobrecomprados e sobrevendidos usando o indicador RSI",
    ...
    {
      title: "Médias Móveis",
      description: "Encontre ativos com cruzamentos de médias móveis e sinais de tendência",
    ...
    },
    {
      ...
      description: "Identifique ativos próximos aos limites das Bandas de Bollinger",
    ...
    },
    {
      ...
      description: "Crie filtros personalizados com múltiplos indicadores técnicos",
    ...
    <div className="container py-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">
          Ferramentas para identificar oportunidades de investimento com base em diversos indicadores técnicos
        </p>
      </div>
