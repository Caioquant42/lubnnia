...
export default function CollarStrategyPage() {
  ...
  const [collarData, setCollarData] = useState<{[key: string]: {[key: string]: CollarStrategy[]}}>({});
  const [selectedStrategy, setSelectedStrategy] = useState<CollarStrategy | null>(null);
  ...
  if (selectedStrategy) {
    return (
      <div className="container mx-auto py-6">
        ...
        <CollarStrategyDetail strategy={selectedStrategy} onClose={handleBackToList} />
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight">Estratégia de Collar</h1>
        <p className="text-muted-foreground">
          Um collar é uma estratégia de opções que limita tanto o potencial de alta quanto o risco de baixa de uma posição subjacente.
        </p>
        ...
        <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg dark:bg-blue-900/20 dark:border-blue-800">
          <p className="text-blue-800 dark:text-blue-200 text-sm">
            ℹ️ Apenas estratégias com prêmios de R$ 0,01 ou superior são exibidas para garantir estratégias atrativas.
          </p>
        </div>
      </div>
            ...
            {collarData.intrinsic && (
              <Tabs defaultValue="less_than_14_days" className="space-y-4">
                ...
                <TabsContent value="less_than_14_days" className="space-y-4">
                  <Card>
                    <CardHeader>
                      <CardTitle>Estratégias de Collar de Curto Prazo (&lt; 14 dias)</CardTitle>
                      <CardDescription>
                        Estratégias de collar com menos de 14 dias para o vencimento que fornecem proteção intrínseca
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CollarStrategyTable 
                ...
                <TabsContent value="between_15_and_30_days" className="space-y-4">
                  <Card>
                    <CardHeader>
                      <CardTitle>Estratégias de Collar de Médio Prazo (15-30 dias)</CardTitle>
                      <CardDescription>
                        Estratégias de collar com 15-30 dias para o vencimento que fornecem proteção intrínseca
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CollarStrategyTable 
                ...
                <TabsContent value="between_30_and_60_days" className="space-y-4">
                  <Card>
                    <CardHeader>
                      <CardTitle>Estratégias de Collar de Médio-Longo Prazo (30-60 dias)</CardTitle>
                      <CardDescription>
                        Estratégias de collar com 30-60 dias para o vencimento que fornecem proteção intrínseca
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CollarStrategyTable 
                ...
                <TabsContent value="more_than_60_days" className="space-y-4">
                  <Card>
                    <CardHeader>
                      <CardTitle>Estratégias de Collar de Longo Prazo (&gt; 60 dias)</CardTitle>
                      <CardDescription>
                        Estratégias de collar com mais de 60 dias para o vencimento que fornecem proteção intrínseca
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CollarStrategyTable 
            ...
            {collarData.otm && (
              <Tabs defaultValue="less_than_14_days" className="space-y-4">
                ...
                <TabsContent value="less_than_14_days" className="space-y-4">
                  <Card>
                    <CardHeader>
                      <CardTitle>Estratégias de Collar OTM de Curto Prazo (&lt; 14 dias)</CardTitle>
                      <CardDescription>
                        Estratégias de collar fora do dinheiro com menos de 14 dias para o vencimento
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CollarStrategyTable 
                ...
                <TabsContent value="between_15_and_30_days" className="space-y-4">
                  <Card>
                    <CardHeader>
                      <CardTitle>Estratégias de Collar OTM de Médio Prazo (15-30 dias)</CardTitle>
                      <CardDescription>
                        Estratégias de collar fora do dinheiro com 15-30 dias para o vencimento
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CollarStrategyTable 
                ...
                <TabsContent value="between_30_and_60_days" className="space-y-4">
                  <Card>
                    <CardHeader>
                      <CardTitle>Estratégias de Collar OTM de Médio-Longo Prazo (30-60 dias)</CardTitle>
                      <CardDescription>
                        Estratégias de collar fora do dinheiro com 30-60 dias para o vencimento
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CollarStrategyTable 
                ...
                <TabsContent value="more_than_60_days" className="space-y-4">
                  <Card>
                    <CardHeader>
                      <CardTitle>Estratégias de Collar OTM de Longo Prazo (&gt; 60 dias)</CardTitle>
                      <CardDescription>
                        Estratégias de collar fora do dinheiro com mais de 60 dias para o vencimento
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <CollarStrategyTable 
