...
import { CheckCircle, ArrowRight, Mail, RefreshCw } from "lucide-react";
...
export default function EmailConfirmedPage() {
  ...
  useEffect(() => {
    ...
    if (error) {
      ...
      if (errorCode === 'otp_expired') {
        setError("Link de confirmacao expirado. Solicite um novo e-mail de confirmacao.");
      } else if (errorCode === 'access_denied') {
        setError("Acesso negado. O link pode estar invalido ou ja foi usado.");
      } else {
        setError(errorDescription || "Erro na confirmacao do e-mail");
      }
      setLoading(false);
      return;
    }
    ...
    if (type === 'signup' && token) {
      ...
      setError("Link de confirmacao invalido ou expirado");
      setLoading(false);
    }
  }, [searchParams]);
  ...
  const handleResendConfirmation = async () => {
    ...
    try {
      ...
      const email = searchParams.get('email') || prompt("Digite seu e-mail para reenviar a confirmacao:");
      
      if (!email) {
        setError("E-mail e obrigatorio para reenviar a confirmacao");
      ...
      setError("E-mail de confirmacao reenviado! Verifique sua caixa de entrada.");
    } catch (err: any) {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-muted-foreground">Verificando confirmacao...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex flex-1 items-center justify-center p-4">
          <div className="w-full max-w-md space-y-8">
            <div className="flex flex-col items-center text-center">
              ...
              <h1 className="mt-3 text-3xl font-bold text-finance-danger-500">Erro na Confirmacao</h1>
            </div>
              ...
              <CardContent className="pt-6">
                <div className="flex flex-col items-center space-y-4 text-center">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg font-semibold">Problema na Confirmacao</h3>
            ...
            <CardContent className="pt-6">
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Seu e-mail foi confirmado com sucesso. Agora voce tem acesso completo a plataforma.
                  </p>
                </div>
                ...
                <div className="w-full space-y-3 mt-6">
                  <div className="flex items-center space-x-3 text-sm">
                    ...
                    <span>Estrategias de trading quantitativo</span>
                  </div>
                  <div className="flex items-center space-x-3 text-sm">
                    <CheckCircle className="h-4 w-4 text-finance-success-500" />
                    <span>Analise de mercado em tempo real</span>
                  </div>
                  <div className="flex items-center space-x-3 text-sm">
                    <CheckCircle className="h-4 w-4 text-finance-success-500" />
