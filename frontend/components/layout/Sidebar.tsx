...
import { watchlistsData } from "@/data/mock-data";
                ...
                {mainNavItems.map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-3 w-full min-w-0">
                      ...
                      {shouldShowExpanded && (
                        <span className="transition-opacity duration-200 truncate">{item.title}</span>
                      )}
                    </div>
                          ...
                          {item.submenuItems?.map((subItem) => (
                            <Link
                              ...
                              className={cn(
                                ...
                                "py-1",
                                isActive(subItem.href) && "font-medium text-foreground"
                              )}>
                              {subItem.title}
                            </Link>
                          ))}
        ...
        {shouldShowExpanded && (
          <div className="mb-4 mt-auto px-4">
            <div className="rounded-lg border bg-card/50 p-3">
              ...
              <Button className="mt-2 w-full bg-finance-secondary-400 text-finance-primary-800 hover:bg-finance-secondary-500" size="sm">
                Upgrade
              </Button>
            </div>
          </div>
