...
export function QuickActionCenter({ className }: QuickActionCenterProps) {
  ...
  const categories = [
    { id: 'all', name: 'All', count: quickActions.length },
    {
      id: 'trading',
      name: 'Trading',
      count: quickActions.filter((a) => a.category === 'trading').length,
    },
    {
      id: 'analysis',
      name: 'Analysis',
      count: quickActions.filter((a) => a.category === 'analysis').length,
    },
    {
      id: 'screening',
      name: 'Screening',
      count: quickActions.filter((a) => a.category === 'screening').length,
    },
    {
      id: 'strategy',
      name: 'Strategy',
      count: quickActions.filter((a) => a.category === 'strategy').length,
    },
  ];
      ...
      <CardHeader>
        <div className='flex items-center justify-between'>
          <div>
            ...
            <CardDescription>
              Jump to your most-used tools and analyses
            </CardDescription>
          </div>
        </div>
      </CardHeader>
              ...
              <div className='group p-4 border rounded-lg hover:bg-muted/50 transition-colors cursor-pointer'>
                <div className='flex items-start justify-between'>
                  <div className='flex items-start gap-3 flex-1'>
                    <div
                      className={`p-2 rounded-md ${getCategoryColor(action.category)}`}
                    >
                      {action.icon}
                    </div>
