...
import { Banknote, Calendar, CalendarDays, TrendingUp } from 'lucide-react';
...
export function DividendCalendarPopover({
  className,
}: DividendCalendarPopoverProps) {
            ...
            <ScrollArea className='max-h-80'>
              {dividendsByDate.length > 0 ? (
                <div className='p-2'>
                  {dividendsByDate
                    .slice(0, 10)
                    .map(({ date, dividends: dateDividends, totalValue }) => (
                      <div key={date} className='mb-3 last:mb-0'>
                        ...
                        {date !==
                          dividendsByDate[dividendsByDate.length - 1].date && (
