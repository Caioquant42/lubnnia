...
export function RetirementCalculator() {
  ...
  const handleFormattedInputChange = (
    name: 'salary' | 'retirement_income' | 'initial_capital',
    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className='bg-card p-4 border rounded shadow-sm'>
          ...
          <p className='text-sm mt-1'>Capital: {formatCurrency(data.value)}</p>
          ...
          <p className='text-xs text-muted-foreground mt-1'>
            Fase:{' '}
            {data.phase === 'accumulation' ? 'Acumulação' : 'Distribuição'}
          </p>
        </div>
      );
    }
            ...
            <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3'>
                ...
                <div className='flex items-center gap-2'>
                  <Slider
                    ...
                    onValueChange={(values) =>
                      handleParamChange('current_age', values[0])
                    }
                  />
              ...
              <div className='space-y-2'>
                ...
                <div className='flex items-center gap-2'>
                  <Slider
                    ...
                    onValueChange={(values) =>
                      handleParamChange('retirement_age', values[0])
                    }
                  />
              ...
              <div className='space-y-2'>
                ...
                <div className='flex items-center gap-2'>
                  <Slider
                    ...
                    onValueChange={(values) =>
                      handleParamChange('max_age', values[0])
                    }
                  />
              ...
              <div className='space-y-2'>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleFormattedInputChange('salary', e.target.value)
                  }
                  placeholder='0'
                />
              </div>
              ...
              {/* Retirement income */}
              <div className='space-y-2'>
                <Label htmlFor='retirement_income'>
                  Renda na Aposentadoria (R$)
                </Label>
                <Input
              ...
              <div className='space-y-2'>
                <Label htmlFor='investment_fraction'>
                  Fração Investida{' '}
                  {results && `(${formatPercent(results.investment_fraction)})`}
                </Label>
                <div className='flex items-center gap-2'>
                  <Slider
                    ...
                    onValueChange={(values) =>
                      handleParamChange('investment_fraction', values[0])
                    }
                  />
              ...
              <div className='space-y-2'>
                <Label htmlFor='accumulation_rate'>
                  Taxa de Acumulação (%)
                </Label>
                <div className='flex items-center gap-2'>
                  <Slider
                    ...
                    onValueChange={(values) =>
                      handleParamChange('accumulation_rate', values[0])
                    }
                  />
              ...
              <div className='space-y-2'>
                <Label htmlFor='distribution_rate'>
                ...
                <div className='flex items-center gap-2'>
                  <Slider
                    ...
                    onValueChange={(values) =>
                      handleParamChange('distribution_rate', values[0])
                    }
                  />
                  <span className='w-16 text-right'>
              ...
              <div className='grid gap-4 mt-4 md:grid-cols-3'>
                ...
                <Card>
                  ...
                  <CardContent className='p-4 pt-0'>
                    ...
                    <p className='text-xs text-muted-foreground mt-1'>
                      Valor investido ao longo de{' '}
                      {params.retirement_age - params.current_age} anos
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className='p-4 pt-0'>
                    ...
                    <p className='text-xs text-muted-foreground mt-1'>
                      {(
                        (results.investment_returns /
                          results.total_contributed) *
                        100
                      ).toFixed(0)}
                      % do seu montante final
                    </p>
                  </CardContent>
                </Card>
              </div>
              ...
              {results && (
                <div className='mt-6 p-4 bg-muted rounded-lg'>
                  ...
                  <div className='mb-4 p-3 bg-orange-500/10 border border-orange-500/20 rounded-lg'>
                    <div className='text-center'>
                      <p className='text-xs text-muted-foreground mb-1'>
                        Fração de Investimento Necessária
                      </p>
                      ...
                      <p className='text-sm text-muted-foreground mt-1'>
                        {formatCurrency(
                          results.investment_fraction * params.salary
                        )}{' '}
                        por ano
                      </p>
                    </div>
                  ...
                  <div className='grid gap-2 text-sm'>
                    <p>
                      Para atingir sua meta de aposentadoria, você deve investir{' '}
                      <strong>
                        {formatPercent(results.investment_fraction)}
                      </strong>{' '}
                      da sua renda anual (
                    ...
                    <p>
                      Aos {params.retirement_age} anos, você terá acumulado{' '}
                      <strong>
                        {formatCurrency(results.final_accumulation)}
                      </strong>
                      , sendo {formatCurrency(results.investment_returns)}{' '}
                      provenientes de retornos dos investimentos.
                    </p>
                    <p>
                      {results.depletion_age ? (
                        <>
                          Seus recursos se esgotarão aos{' '}
                          <strong>{results.depletion_age}</strong> anos.
                        </>
                      ) : (
                        <>
                          Seus recursos durarão além dos{' '}
                          <strong>{params.max_age}</strong> anos, com saldo
                          final de{' '}
                          {formatCurrency(results.distribution_ending_balance)}.
                        </>
                      )}
                    </p>
                  </div>
...
const CombinedRetirementChart = ({
  ...
  return (
    <div className='h-[400px] w-full'>
      <ResponsiveContainer width='100%' height='100%'>
        <AreaChart margin={{ top: 40, right: 30, left: 30, bottom: 10 }}>
          <CartesianGrid
            strokeDasharray='3 3'
            vertical={false}
            strokeOpacity={0.2}
