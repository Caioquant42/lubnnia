...
const StockVariationChart: React.FC<StockVariationChartProps> = ({
  timeRange = '1D',
}) => {
      ...
      <Card className='w-full'>
        <CardHeader className='pb-3'>
          ...
          <CardDescription className='text-sm'>
            Sentimento do mercado e mudanças de preço -{' '}
  ...
  const topGainers = stocks.filter((stock) => stock.variation > 0).slice(0, 3);
          ...
          {sentiment && (
            <div className='grid grid-cols-1 md:grid-cols-3 gap-3'>
              <div className='flex items-center justify-between p-3 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border'>
                ...
                <span
                  className={`text-sm font-bold ${getSentimentColor(sentiment.sentiment)}`}
                >
                  {sentiment.sentiment}
                </span>
              </div>
              ...
              <div className='flex items-center justify-between p-3 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border'>
                ...
                <Badge
                  variant={getVariationBadgeVariant(sentiment.avgVariation)}
                  className='text-sm'
                >
              ...
              <div className='flex items-center justify-between p-3 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border'>
                ...
                <span className='text-sm font-bold text-green-600'>
                  ...
                  {((sentiment.positiveCount / stocks.length) * 100).toFixed(0)}
                  %)
                </span>
              </div>
            </div>
            ...
            <div className='p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200 shadow-sm'>
              ...
              <div className='space-y-3'>
                {topGainers.map((stock, index) => (
                  <div
                    key={stock.symbol}
                    className='flex justify-between items-center p-2 bg-white/60 rounded-md border border-green-200/50'
                  >
                    ...
                    <Badge
                      variant='default'
                      className='text-xs h-7 px-2 font-semibold bg-green-600 hover:bg-green-700'
                    >
            ...
            <div className='p-4 bg-gradient-to-br from-red-50 to-red-100 rounded-lg border border-red-200 shadow-sm'>
              ...
              <div className='space-y-3'>
                {topDecliners.map((stock, index) => (
                  <div
                    key={stock.symbol}
                    className='flex justify-between items-center p-2 bg-white/60 rounded-md border border-red-200/50'
                  >
                    <div className='flex items-center gap-3'>
