    ...
    async function loadInitialData() {
      try {
        ...
        if (dates.length > 0) {
          ...
          const response = await fetchRRGData({
            date: mostRecentDate,
            limit: 500,
          });
            ...
            <div className='space-y-4'>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={loadQuadrantData}
                >
                  <SelectTrigger>
              ...
              <div>
                <div className='flex justify-between mb-1'>
                  ...
                  <div className='text-xs text-gray-500'>
                    {minRSRatio !== null ? minRSRatio.toFixed(2) : 'Min'} -{' '}
                    {maxRSRatio !== null ? maxRSRatio.toFixed(2) : 'Max'}
                  </div>
                </div>
              ...
              <div>
                <div className='flex justify-between mb-1'>
                  ...
                  <div className='text-xs text-gray-500'>
                    {minRSMomentum !== null ? minRSMomentum.toFixed(2) : 'Min'}{' '}
                    -{' '}
                    {maxRSMomentum !== null ? maxRSMomentum.toFixed(2) : 'Max'}
                  </div>
                </div>
                <div className='flex items-center gap-2'>
                  <Input
                        ...
                        {getSortedData().map((item, index) => (
                          <TableRow key={`${item.symbol}-${index}`}>
                            ...
                            <TableCell>
                              ...
                              `}
                              >
                                {item.quadrant.charAt(0).toUpperCase() +
                                  item.quadrant.slice(1)}
                              </Badge>
                            </TableCell>
