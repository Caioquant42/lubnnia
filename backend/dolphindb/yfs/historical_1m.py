...
def fetch_and_save_data(ticker_symbol, interval):
    ...
    try:
        ...
        historical_data = stock_data.history(period="5d", interval=interval, auto_adjust=False)
        ...
        # Assuming you want to convert 'Datetime' to int64 and then perform the operation
