        ...
        try:
            ...
            with open(csv_filename, 'w', newline='') as csvfile:
                ...
                for data_point in historical_data['data']:
                    csvwriter.writerow([
                        datetime.fromtimestamp(data_point['time'] / 1000).strftime('%Y-%m-%d %H:%M:%S'),  # Convert milliseconds to date and include time
...
def load_csv_to_dolphindb(symbol, resolution):
    try:
        ...
        # Ensure 'Resolution' and 'Symbol' are string type
...
if __name__ == "__main__":
    resolution = '1h'  # You can change this if needed
