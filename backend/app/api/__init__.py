...
def index():
    return make_response(jsonify({
        ...
        "endpoints": [  
            ...
            '/api/crypto-collar',  # Crypto collar strategy endpoint
            'GET /api/crypto-collar?underlying=BTC',  # Filter by cryptocurrency (BTC, ETH, SOL, etc.)
            'GET /api/crypto-collar?underlying=ETH&exchange=bybit',  # Filter by underlying and exchange
            ...
            'GET /api/tail-hedge?underlying=BTC&portfolio_size=1000&portfolio_type=units&portfolio_hedge_percentage=1.0&financing_percentage=1.0',
